...
SKIN.Colours.Button.Normal				= Color( 211, 213, 212, 255 );
SKIN.Colours.Button.Hover				= Color( 255, 255, 255, 255 );
SKIN.Colours.Button.Down				= Color( 211, 211, 211, 255 );
SKIN.Colours.Button.Disabled			= Color( 150, 150, 150, 255 );
...
function SKIN:PaintFrame( panel, w, h )
	...
	DisableClipping( true );
	surface.SetDrawColor( 255, 255, 255, 255 );
	surface.SetMaterial( matPDA );
	surface.DrawTexturedRectUV( 0, 0, w, h, 0, 0.25, 1, 1 );
	DisableClipping( false );
...
function SKIN:PaintButton( panel, w, h )
	...
	if( panel.m_bCloseButton ) then
		...
		if( panel:IsHovered() ) then
			...
			surface.SetDrawColor( 255, 255, 255, 255 );
			surface.SetMaterial( matPDA );
			surface.DrawTexturedRectUV( 0, 0, w, h, 0.128, 0.03, 0.16, 0.061 );
			DisableClipping( false );
			...
			surface.SetDrawColor( 255, 255, 255, 255 );
			surface.SetMaterial( matPDA );
			surface.DrawTexturedRectUV( 0, 0, w, h, 0.095, 0.03, 0.1266, 0.061 );
			DisableClipping( false );
	...
	if( panel.m_bIsDown ) then
		...
		surface.SetDrawColor( 255, 255, 255, 255 );
		surface.SetMaterial( matPDA );
		surface.DrawTexturedRectUV( 0, 0, w + 18, h, 0.6142, 0.21, 0.782, 0.236 );
		DisableClipping( false );
		return;
	...
	if( panel:IsHovered() ) then
		...
		surface.SetDrawColor( 255, 255, 255, 255 );
		surface.SetMaterial( matPDA );
		surface.DrawTexturedRectUV( 0, 0, w + 18, h, 0.443, 0.21, 0.613, 0.236 );
		DisableClipping( false );
		return;
	...
	surface.SetDrawColor( 255, 255, 255, 255 );
	surface.SetMaterial( matPDA );
	surface.DrawTexturedRectUV( 0, 0, w + 18, h, 0.274, 0.21, 0.444, 0.236 );
	DisableClipping( false );
...
derma.DefineSkin( "PDA", "rusty", SKIN );
