...
ITEM.BulkPrice =  120
ITEM.License =  "F"
ITEM.ConsumeText = "You notice these assorted nuts have very unique textures to each one. Some crunchy, some soft. The protein is a welcome treat no matter what form it takes."
ITEM.UseText = "Eat"
