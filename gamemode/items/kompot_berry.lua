...
ITEM.functions.Use = {
	...
	OnUse = function(self)
		...
		if( CLIENT ) then
			...
			GAMEMODE:AddChat( Color( 200, 200, 200, 255 ), "CombineControl.ChatNormal", "The sweet liquid washes down your throat, and it's quite satisfying. The solid fruit itself is delightful as well. You remind yourself that such a happily refreshing culinary experience is rare and regret not adequately savoring this one. If only the winter fruits were colder.", { CB_ALL, CB_IC } );
