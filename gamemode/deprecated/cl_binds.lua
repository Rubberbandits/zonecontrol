...
function GM:PlayerBindPress( ply, bind, down )
	...
	if( down and string.find( bind, "+menu_context" ) ) then
		...
		elseif( LocalPlayer():GetActiveWeapon() and LocalPlayer():GetActiveWeapon():IsValid() and LocalPlayer():GetActiveWeapon():GetClass() == "gmod_tool" ) then
	...
	if( !down and string.find( bind, "+menu_context" ) ) then
		...
		elseif( LocalPlayer():GetActiveWeapon() and LocalPlayer():GetActiveWeapon() != NULL and LocalPlayer():GetActiveWeapon():GetClass() == "gmod_tool" ) then
