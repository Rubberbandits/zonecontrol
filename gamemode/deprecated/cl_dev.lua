...
function GM:CreateIronDev()
	...
	function CCP.IronDev.OutputHolster:DoClick()
...
function GM:CreateItemDev()
	...
	function CCP.ItemDev.FOV:OnValueChanged()
	...
	for _, v in pairs( { "x", "y", "z" } ) do
		...
		CCP.ItemDev.CamPos[v]:SetMin( -100 );
		CCP.ItemDev.CamPos[v]:SetMax( 100 );
		...
		CCP.ItemDev.CamPos[v].OnValueChanged = function( self )
	...
	for _, v in pairs( { "x", "y", "z" } ) do
		...
		CCP.ItemDev.LookAt[v].OnValueChanged = function( self )
