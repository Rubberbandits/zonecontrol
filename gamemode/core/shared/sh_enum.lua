...
LOCATION_CORDON = 1;
LOCATION_GARBAGE = 2;
LOCATION_GREATSWAMP = 3;
LOCATION_DARKSCAPE = 4
LOCATION_RASPAD = 5;
LOCATION_AGROPROM = 6;
LOCATION_ROSTOK = 7;
LOCATION_TRUCKCEMETERY = 8;
LOCATION_CROSSROADS = 9;
LOCATION_REDFOREST = 10;
LOCATION_SWAMP = 11;
LOCATION_ARMYWAREHOUSES = 12;
LOCATION_JUPITER = 13;
LOCATION_OUTSIDE_ZONE = 14;
