...
SWEP.Itemize = true;
SWEP.ItemDescription = "A fragmentation grenade. After the pin is pulled and a short delay, it will explode, injuring anyone near it.";
SWEP.ItemWeight = 1;
SWEP.ItemFOV = 8;
