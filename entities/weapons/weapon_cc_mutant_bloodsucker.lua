...
SWEP.PrintName 		= "Bloodsucker Claws"
SWEP.Slot 			= 1
SWEP.SlotPos 		= 10

SWEP.UseHands		= true
SWEP.ViewModel 		= "models/weapons/c_arms_citizen.mdl"
SWEP.WorldModel 	= "models/jawkrovosos.mdl"
...
function SWEP:PrimaryUnholstered()
	...
	if self.Owner:GetVelocity():Length() < 5 then
		self.Owner:PlayVCD( "STAND_ATTACK_"  .. math.random(0, 1));
		...
		self.Owner:PlayVCD( "STAND_ATTACK_RUN_0" );
