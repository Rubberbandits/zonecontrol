...
ENT.AdminOnly		= true;
	...
	local loot_table = {
		{"med_medkit", "antirad", "antirad"},
		{"med_medkit", "antidote", "antirad", "antirad"},
		{"med_medkit", "radpills", "antirad", "antirad"},
		{"med_armykit", "antirad", "antirad", "psypills"},
		{"med_armykit", "radpills", "antirad", "antirad", "psypills"},
		{"med_armykit", "antidote", "antirad", "psypills"},
		{"med_scikit", "antirad", "antirad", "psypills", "anabiotic"},
		{"med_scikit", "antirad", "antirad"},
		{"antirad", "antirad", "antirad", "antirad", "antirad", "antirad", "antirad", "antirad"},
		{"brick"},
		{"sausage", "bread"},
		{"sausage", "bread", "booster"},
		{"sausage", "sausage", "bread", "bread"},
 		{"energydrink", "energydrink", "energydrink", "energydrink"}, 
		{"booster"},
	}
...
local parts = {
	{"models/z-o-m-b-i-e/st/box/part/st_box_metall_01_1.mdl", Vector(0,0,0)},
	{"models/z-o-m-b-i-e/st/box/part/st_box_metall_01_2.mdl", Vector(0,0,1)},
}

function ENT:Open()

	self:EmitSound( "items/ammocrate_open.wav", 75 )
	self.HasOpened = true
