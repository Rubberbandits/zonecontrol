...
ENT.Leaping = false
ENT.alert1 = Sound("kingston/monsters/bloodsucker/sucker_growl_1.ogg")
ENT.alert2 = Sound("kingston/monsters/bloodsucker/sucker_growl_2.ogg")
ENT.alert3 = Sound("kingston/monsters/bloodsucker/vampire_grasp.ogg")
ENT.idle1 = Sound("kingston/monsters/bloodsucker/idle_1.ogg")
ENT.idle2 = Sound("kingston/monsters/bloodsucker/idle_2.ogg")
ENT.idle3 = Sound("kingston/monsters/bloodsucker/idle_3.ogg")
ENT.idle4 = Sound("kingston/monsters/bloodsucker/idle_4.ogg")
ENT.angryidle1 = Sound("kingston/monsters/bloodsucker/sucker_breath_1.ogg")
ENT.angryidle2 = Sound("kingston/monsters/bloodsucker/sucker_breath_1.ogg")
ENT.angryidle3 = Sound("kingston/monsters/bloodsucker/sucker_breath_1.ogg")
ENT.angryidle4 = Sound("kingston/monsters/bloodsucker/sucker_breath_1.ogg")
ENT.attack1 = Sound("kingston/monsters/bloodsucker/attack_1.ogg")
ENT.attack2 = Sound("kingston/monsters/bloodsucker/attack_2.ogg")
ENT.attack3 = Sound("kingston/monsters/bloodsucker/attack_1.ogg")
ENT.attack4 = Sound("kingston/monsters/bloodsucker/attack_2.ogg")
ENT.attack5 = Sound("kingston/monsters/bloodsucker/attack_1.ogg")
ENT.attack6 = Sound("kingston/monsters/bloodsucker/attack_2.ogg")
ENT.attackmiss1 = Sound("misses/miss1.ogg")
ENT.attackmiss2 = Sound("misses/miss2.ogg")
ENT.attackmiss3 = Sound("misses/miss3.ogg")
ENT.attackmiss4 = Sound("misses/miss4.ogg")
ENT.attackleap = Sound("")
ENT.hurt1 = Sound("")
ENT.hurt2 = Sound("")
ENT.hurt3 = Sound("")
ENT.die1 = Sound("kingston/monsters/bloodsucker/die_1.ogg")
ENT.die2 = Sound("kingston/monsters/bloodsucker/die_1.ogg")
ENT.die3 = Sound("kingston/monsters/bloodsucker/die_1.ogg")
ENT.dead = false

ENT.model1 = "models/tnb/stalker/bloodsucker2.mdl"
ENT.model2 = "models/tnb/stalker/bloodsucker2.mdl"
...
function ENT:Attack_Melee()
	...
	timer.Create( "melee_done_timer" .. self.Entity:EntIndex( ), 0.8, 1, function() self:setmeleefalse() end )
end
    ...
    if GetConVarNumber("ai_disabled") == 0 then
		...
		if self:GetEnemy() != nil then
				if math.random(1,15) == 1 && self:GetPos():Distance(self:GetEnemy():GetPos()) < self.LeapDistance && self:GetPos():Distance(self:GetEnemy():GetPos()) > self.MinLeapDistance && self.Leaps == true && self.Leaping == false then
					...
					timer.Simple(0.25,function() self:setmeleefalse()end )
				end
				if (self:GetEnemy():GetPos():Distance(self:GetPos()) < 70) || self:HasPropInFrontOfMe() then
					if self.MeleeAttacking == false then
						...
						timer.Create( "melee_attack_timer" .. self.Entity:EntIndex( ), 0.5, 1, function() self:Attack_Melee() end )
